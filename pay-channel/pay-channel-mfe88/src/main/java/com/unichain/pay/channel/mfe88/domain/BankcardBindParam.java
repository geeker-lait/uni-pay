...
import com.unichain.pay.channel.mfe88.Mfe88SignPayParam;
 ...
 */
@Data
public class BankcardBindParam implements Mfe88SignPayParam {
    ...
    @Override
    public PayParam decrypt(String encryptKey) {
