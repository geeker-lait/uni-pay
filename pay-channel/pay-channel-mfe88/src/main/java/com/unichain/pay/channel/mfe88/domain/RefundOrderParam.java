 ...
 */
@Data
public class RefundOrderParam implements PayParam {
    ...
    public PayParam convert(PayRequest payRequest) {
        Map<String, Object> map = payRequest.getPayParamMap();
        RefundOrderParam refundOrderParam = BeanUtil.mapToBean(map, this.getClass(), true);
        BeanUtil.copyProperties(refundOrderParam, this);
