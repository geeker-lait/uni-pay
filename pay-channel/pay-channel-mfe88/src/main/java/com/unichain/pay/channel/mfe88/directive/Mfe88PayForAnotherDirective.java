...
public class Mfe88PayForAnotherDirective implements PayDirective<PayForAnotherParam,PayForAnotherResponse> {
    @Override
    ...
    @Override
    public PayForAnotherParam buildPayParam(PayRequest payRequest, ChannelConfig channelConfig) {
        return null;
    }
    ...
    @Override
    public PayForAnotherResponse record(PayForAnotherParam payParam, PayRequest payRequest, PayForAnotherResponse payResponse) {
        return null;
    }
